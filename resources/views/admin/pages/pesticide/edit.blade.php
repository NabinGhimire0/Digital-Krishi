                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-block btn-primary" href="/pesticide">Back</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/pesticide/{{ $pesticide->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="30" rows="10">{!! $pesticide->description !!}</textarea>
