...
class SeedController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $seed->save();
        return redirect('admin/seeds')->with('status', 'Seed created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $seed->user_id = auth()->user()->id;
        $seed->update();
        return redirect('admin/seeds')->with('status', 'Seed updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        $seed = Seed::find($id);
        $seed->delete();
        return redirect('admin/seeds')->with('status', 'Seed deleted successfully.');
    }
}
